...
public class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(181.05-20+180+20);
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(59.1);
